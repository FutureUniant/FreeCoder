...
export function IconPuzzle(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M10 4a2 2 0 1 1 4 0v2h2a2 2 0 1 1 0 4h-2v2a2 2 0 1 1-4 0v-2H8a2 2 0 1 1 0-4h2V4Z" />
      <path d="M6 14v3a3 3 0 0 0 3 3h3" />
      <path d="M14 20h1a3 3 0 0 0 3-3v-1" />
      <path d="M20 10V9a3 3 0 0 0-3-3h-1" />
    </Svg>
  );
}

/** Local Bonsai — leaf. */
export function IconBonsai(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M12 21v-7" />
      <path d="M12 14c-4-1-6-4-6-7 3 0 5 1.5 6 3.5C13 8.5 15 7 18 7c0 3-2 6-6 7Z" />
      <path d="M8 21h8" />
    </Svg>
  );
}
...
/** Generic cloud model. */
export function IconModelGeneric(props: IconProps) {
  return (
    <Svg {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="M8 12h8" />
