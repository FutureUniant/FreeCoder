...
pub use permission_gate::{
    decision_blocks_tool, permission_outcome_value, permission_outcome_value_with_options,
    GateError, ParkedPermission, PermissionGate,
};
...
pub enum BridgeError {
    ...
    Rpc {
        code: i64,
        message: String,
        /// Product code from `error.data.app_code` when present.
